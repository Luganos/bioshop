             <div id ="payment-address-input"> 
                  ...
                  <input type="hidden" name="address_2"  value="" placeholder="" id="input-payment-address-address_2" class="form-control" />
                  ...
                  <input type="hidden" name="payment_address"  value="existing" placeholder="" id="input-payment-address-payment_address" class="form-control" /> 
